...
if(NOT DEFINED Slicer_REQUIRED_C_FLAGS OR NOT DEFINED Slicer_REQUIRED_CXX_FLAGS)
  ...
  elseif(MSVC)
    set(tmp_c_flags /GS /DynamicBase /NXCompat /SafeSEH)
    set(tmp_cxx_flags /GS /DynamicBase /NXCompat /SafeSEH)
    # if 64-bit Windows link with /bigobj
    if(CMAKE_SIZEOF_VOID_P MATCHES 8)
       list(APPEND tmp_c_flags /bigobj)
       list(APPEND tmp_cxx_flags /bigobj)
    endif()
    if(MSVC_VERSION GREATER 1400)
      ...
      if(CMAKE_CXX_MP_FLAG)
        list(APPEND tmp_c_flags "${tmp_c_flags} /MP${CMAKE_CXX_MP_NUM_PROCESSORS}")
        list(APPEND tmp_cxx_flags "${tmp_cxx_flags} /MP${CMAKE_CXX_MP_NUM_PROCESSORS}")
      endif()
    endif()
  endif()
