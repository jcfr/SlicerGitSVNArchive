...
void qSlicerExtensionsInstallWidget::setExtensionsManagerModel(qSlicerExtensionsManagerModel* model)
{
  ...
  if (d->ExtensionsManagerModel)
    {
    QObject::connect(d->ExtensionsManagerModel, SIGNAL(extensionInstalled(QString)),
                     this, SLOT(onExtensionInstalled(QString)));

    QObject::connect(d->ExtensionsManagerModel, SIGNAL(extensionUninstalled(QString)),
                     this, SLOT(onExtensionUninstalled(QString)));

    QObject::connect(d->ExtensionsManagerModel, SIGNAL(slicerRequirementsChanged(QString,QString,QString)),
