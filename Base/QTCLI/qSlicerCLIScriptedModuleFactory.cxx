...
// SlicerQt includes
#include "qSlicerCLIScriptedModuleFactory.h"
...
//-----------------------------------------------------------------------------
qSlicerCLIScriptedModuleFactoryItem::qSlicerCLIScriptedModuleFactoryItem(
  const QString& newTempDirectory) : TempDirectory(newTempDirectory)
{
}

//-----------------------------------------------------------------------------
bool qSlicerCLIScriptedModuleFactoryItem::load()
{
  return true;
}

//-----------------------------------------------------------------------------
qSlicerAbstractCoreModule* qSlicerCLIScriptedModuleFactoryItem::instanciator()
{
...
//-----------------------------------------------------------------------------
qSlicerCLIScriptedModuleFactory::qSlicerCLIScriptedModuleFactory()
{
  this->TempDirectory = QDir::tempPath();
}

//-----------------------------------------------------------------------------
qSlicerCLIScriptedModuleFactory::qSlicerCLIScriptedModuleFactory(const QString& tempDir)
{
  this->setTempDirectory(tempDir);
}

//-----------------------------------------------------------------------------
void qSlicerCLIScriptedModuleFactory::registerItems()
{
...
//-----------------------------------------------------------------------------
bool qSlicerCLIScriptedModuleFactory::isValidFile(const QFileInfo& file)const
{
...
//-----------------------------------------------------------------------------
ctkAbstractFactoryItem<qSlicerAbstractCoreModule>* qSlicerCLIScriptedModuleFactory
::createFactoryFileBasedItem()
{
  return new qSlicerCLIScriptedModuleFactoryItem(this->TempDirectory);
}

//-----------------------------------------------------------------------------
QString qSlicerCLIScriptedModuleFactory::fileNameToKey(const QString& executableName)const
{
  return qSlicerUtils::extractModuleNameFromLibraryName(executableName);
}

//-----------------------------------------------------------------------------
void qSlicerCLIScriptedModuleFactory::setTempDirectory(const QString& newTempDirectory)
{
