...
bool qSlicerExtensionsManagerModel::installExtensionPackage(const QString& archiveFile)
{
  ...
  metadata.insert("archivename", QFileInfo(archiveFile).fileName());
  metadata.insert("arch", this->slicerArch());
  metadata.insert("slicer_revision", this->slicerRevision());
  metadata.insert("os", this->slicerOs());
  // XXX Check metadata
