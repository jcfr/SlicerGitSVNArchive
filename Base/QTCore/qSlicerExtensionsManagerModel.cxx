...
// --------------------------------------------------------------------------
void qSlicerExtensionsManagerModel::checkCompatibility() const
{
  Q_D(const qSlicerExtensionsManagerModel);
  foreach(const QString& extensionName, this->installedExtensions())
    {
    QString reasons = this->isExtensionCompatibile(extensionName, d->SlicerRevision, d->SlicerOs, d->SlicerArch);
    if (!reasons.isEmpty())
      {
...
// --------------------------------------------------------------------------
QString qSlicerExtensionsManagerModel::isExtensionCompatibile(
