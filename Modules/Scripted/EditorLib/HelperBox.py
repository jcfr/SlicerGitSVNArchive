...
class HelperBox(object):
  ...
  def onEnter(self):
    ...
    tag = slicer.mrmlScene.AddObserver(slicer.vtkMRMLScene.NodeAddedEvent, self.structureListWidget.updateStructures)
    self.observerTags.append( (slicer.mrmlScene, tag) )
    tag = slicer.mrmlScene.AddObserver(slicer.vtkMRMLScene.NodeRemovedEvent, self.structureListWidget.updateStructures)
    self.observerTags.append( (slicer.mrmlScene, tag) )
