...
public:
  ...
  Q_INVOKABLE virtual vtkSlicerApplicationLogic* mrmlApplicationLogic()const;
  Q_INVOKABLE virtual void setMRMLApplicationLogic(vtkSlicerApplicationLogic* appLogic);
